...
lyr_red = 'T31TDF_20150802T104026_B04'
lyr_ir = 'T31TDF_20150802T104026_B08'
# Set this path before runing the script
lyr_ndvi = '/home/diego/Documents/maps/Barcelona/images/NDVI_2015_int.tif'
...
calc = QgsRasterCalculator( '("ir@1" - "red@1") / ("ir@1" + "red@1") * 100', lyr_ndvi, 'GTiff', ras_red.raster.extent(), ras_red.raster.width(), ras_red.raster.height(), entries )
